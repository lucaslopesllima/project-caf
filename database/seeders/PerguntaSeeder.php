    ...
    public function run(): void
    {
        $perguntas = [
            ...
            "text" => [
                ...
                "Conte sobre um desafio recente que você enfrentou.",
                "O que você costuma fazer no seu tempo livre?",
                "Existe algo que você gostaria de mudar em sua comunidade?",
                "Quais são suas expectativas em relação ao futuro?",
                "Você gostaria de compartilhar alguma experiência marcante?"
            ]
        ];


        foreach ($perguntas as $type => $list) {
